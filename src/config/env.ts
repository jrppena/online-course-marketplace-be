...
const EnvSchema = z
  .object({
    ...
    DATABASE_URL: z.string().min(1), // Neon pooled connection string
    DIRECT_URL: z.string().min(1), // Neon direct connection string (migrations)
...
export const DIRECT_URL = env.DIRECT_URL;
